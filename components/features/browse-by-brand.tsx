...
export function BrowseByBrand({
  ...
  /* Stronger borders */
  const borderColor = isLight ? "rgba(23,21,18,0.16)" : `${PAPER}18`;

  const cardBorderColor = isLight ? "rgba(23,21,18,0.13)" : `${PAPER}14`;

  const cardBackground = isLight ? "rgba(255,255,255,0.62)" : `${PAPER}04`;
  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        viewport={viewport}
        className="container relative mx-auto py-16 px-4 sm:py-20 lg:py-24"
      >
        {/* ------------------------------------------------------------------ */}
        {/* Header                                                             */}
        {/* ------------------------------------------------------------------ */}
        ...
        >
          ...
          <Link
            ...
            style={{
              borderColor: isLight ? "rgba(23,21,18,0.20)" : `${PAPER}25`,
        ...
        <motion.div
          ...
          style={{
            ...
            boxShadow: isLight ? "0 18px 50px rgba(23,21,18,0.06)" : "none",
          }}
        >
